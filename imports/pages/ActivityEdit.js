  ...
  hanldeSubmit(e) {
    ...
    if (this.props.editStatus) {
      ...
      if (!this.checkValidation()) {
        this.setState({errorMsg: '信息填写不完整', errorStatus: true, confirmStatus: false});
        return;
      }
          ...
          <form onSubmit={this.hanldeSubmit.bind(this)}>
            <Card style={{marginBottom: 10}}  onClick={this.handleUploadImageClick.bind(this)}>
              <CardMedia overlay={<CardTitle title={this.props.editStatus ? "点击更换图片" : "点击上传图片"} />} overlayContentStyle={{display: "flex", justifyContent: "center"}}>
                <img src={this.props.editStatus ? this.props.activity&&this.props.activity.cover : "/images/federer.png"} alt="" type="submit"/>
              </CardMedia>
            </Card>
            <input type="file" ref="imageUpload" style={{visibility: "collapse", marginTop: -36}}/>
